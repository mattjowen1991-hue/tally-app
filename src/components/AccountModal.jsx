                ...
                <>
                  ...
                  <div style={{ marginTop: '12px', display: 'flex', flexDirection: 'column', gap: '6px' }}>
                    ...
                    {[
                      ...
                      { label: 'Single missed bill', title: 'Tally', body: 'Your Netflix payment was missed — £15.99', id: 99994 },
                      { label: 'Grouped missed bills', title: 'Tally — 3 bills missed', body: 'Netflix (£15.99)\nPhone (£45.00)\nGym (£29.99)', id: 99995 },
                    ].map(n => (
                      <button
                        key={n.id}
                        onClick={async () => {
